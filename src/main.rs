...
fn main() {
    ...
    let instructions = [(0x00, "NOP"), (0x01, "LD BC,d16"), (0x02, "LD (BC),A"),
    ...
    let cb_instructions = [(0x00, "RLC B"), (0x01, "RLC C"), (0x02, "RLC D"), (0x03, "RLC E"), (0x04, "RLC H"),
    ...
    let mut instr_name = String::default();
